...
btn1.addEventListener("click", function () {   
    ...
    if(email.value.length === 0){
        ...
        $.ajax({
            url: '/ciroc/employeepassword/verification',
            method: 'POST',
    ...
    if(accessNum === null){
        ...
        if (newPass.value.match(passMustCharacter)){
            if(newPass.value === confirmNewPass.value){
                ...
                $.ajax({
                    url: '/ciroc/employeepassword/changepassword',
                    method: 'PUT',
                    data: userData,
                    dataType: 'json',  
                    success: function (result) {
                        if(result === "samepassword"){
                            ...
                            popup.innerHTML = "Password successfully changed"
                            popup.classList.toggle("show");
                            setTimeout(function(){
                                popup.classList.remove("show")
                            },2000)
                ...
                popup.innerHTML = "New passwords don't match"
                popup.classList.toggle("show");
                setTimeout(function(){
                    popup.classList.remove("show")
                },2000)
            ...
            popup.innerHTML = "Password syntax wrong"
                            popup.classList.toggle("show");
                            setTimeout(function(){
                                popup.classList.remove("show")
                            },2000)
